<header class="cbp-spmenu-push">
  <nav class="navbar navbar-fixed-top">
      ...
      <a class="cart" href="<?php echo WC()->cart->get_cart_url(); ?>" title="<?php _e( 'View your shopping cart' ); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a> 
      <a class="cart-contents" href="<?php echo WC()->cart->get_cart_url(); ?>"><?php echo WC()->cart->get_cart_total(); ?></a>
